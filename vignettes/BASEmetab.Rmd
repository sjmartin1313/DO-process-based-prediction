---
title: "User guide for package 'BASEmetab_mod'"
author: "Darren Giling, Ralph Mac Nally, Nick Bond & Michael Grace"
modified by: Sonny Martin
date: "`r Sys.Date()`"
output: 
  rmarkdown::pdf_document
vignette: >
  %\VignetteIndexEntry{"User guide for package 'BASEmetab_mod'""}
...
# install BASEmetab package
  devtools::install_github("sjmartin1313/DO-process-based-prediction")
...
#bayesmetab_mod (function)

##Description
bayesmetab_mod is the main function of the BASEmetab package. This function calls JAGS to perform the single-station stream metabolism analysis. 

##Useage

`bayesmetab_mod(data.dir , results.dir, interval, n.iter=20000, n.burnin=n.iter*0.5, 
